...
import credentialsv1 from './context/credentials.json'
import vaccinationContext2 from './context/vaccination.v1.json'
import securityV3Context from './context/securityV3.json'
...
function customLoader(url) {
    const cached = {
      ...
      "https://w3id.org/vaccination/v1": vaccinationContext2,
