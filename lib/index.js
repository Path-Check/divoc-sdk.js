...
const vaccinationContext2 = require('./vaccination.v1.json')
const securityV3Context = require('./securityV3.json')
const pathogen = require('./pathogen-v1.json')
const dgc = require('./dgc-v1.json')
...
async function signAndPack(payload) {
